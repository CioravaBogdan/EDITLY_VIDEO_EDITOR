...
declare namespace easings {
  export { easings_easeInOutCubic as easeInOutCubic, easings_easeOutExpo as easeOutExpo, easings_linear as linear };
 ...
 */
type TransitionType = "directional-left" | "directional-right" | "directional-up" | "directional-down" | "random" | "dummy" | string;
/**
 ...
 */
type CurveType = "tri" | "qsin" | "hsin" | "esin" | "log" | "ipar" | "qua" | "cub" | "squ" | "cbr" | "par" | "exp" | "iqsin" | "ihsin" | "dese" | "desi" | "losi" | "nofade" | string;
 ...
 */
type Position = "top" | "top-left" | "top-right" | "center" | "center-left" | "center-right" | "bottom" | "bottom-left" | "bottom-right" | PositionObject;
/**
...
type LayerType = "video" | "audio" | "detached-audio" | "image" | "image-overlay" | "title" | "subtitle" | "title-background" | "news-title" | "slide-in-text" | "fill-color" | "pause" | "radial-gradient" | "linear-gradient" | "rainbow-colors" | "canvas" | "fabric" | "gl" | "editly-banner";
interface BaseLayer {
    /**
     * Layer type.
     */
 ...
 */
type Layer = VideoLayer | AudioLayer | DetachedAudioLayer | ImageLayer | ImageOverlayLayer | TitleLayer | SubtitleLayer | TitleBackgroundLayer | NewsTitleLayer | SlideInTextLayer | FillColorLayer | PauseLayer | RadialGradientLayer | LinearGradientLayer | RainbowColorsLayer | CanvasLayer | FabricLayer | GlLayer | EditlyBannerLayer;
/**
...
type DefaultLayerTypeOptions = {
    [P in LayerType]?: Partial<Omit<Extract<Layer, {
        type: P;
    }>, "type">>;
};
...
export { Transition, Editly as default, renderSingleFrame };
export type { AudioLayer, AudioNormalizationOptions, AudioTrack, BackgroundLayer, BaseLayer, CanvasLayer, Clip, CurveType, CustomCanvasFunction, CustomCanvasFunctionArgs, CustomCanvasFunctionCallbacks, CustomFabricFunction, CustomFabricFunctionArgs, CustomFabricFunctionCallbacks, DefaultLayerOptions, DefaultLayerTypeOptions, DefaultOptions, DetachedAudioLayer, Easing, EditlyBannerLayer, FabricLayer, FillColorLayer, GLTextureLike, GlLayer, ImageLayer, ImageOverlayLayer, KenBurns, Keyframe, Layer, LayerType, LinearGradientLayer, NewsTitleLayer, OptionalPromise, OriginX, OriginY, PauseLayer, Position, PositionObject, RadialGradientLayer, RainbowColorsLayer, RenderSingleFrameConfig, ResizeMode, RunTransitionOptions, SlideInTextLayer, SubtitleLayer, TextLayer, TitleBackgroundLayer, TitleLayer, TransitionOptions, TransitionParams, TransitionType, VideoLayer, VideoPostProcessingFunctionArgs };
